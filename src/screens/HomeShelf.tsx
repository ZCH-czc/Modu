...
export function HomeShelf({
  ...
  const shelfFilterOptions = useMemo<Array<{ key: ShelfFilter; label: string }>>(
    () => [
      { key: "all", label: resolvedLanguage === "en" ? "All" : "ȫ��" },
      { key: "local", label: resolvedLanguage === "en" ? "Local" : "����" },
      { key: "web", label: resolvedLanguage === "en" ? "Web" : "��ҳ" },
    ],
    [resolvedLanguage],
  );
  const shelfSortLabels = useMemo<Record<ShelfSort, string>>(
    () => ({
      recent: resolvedLanguage === "en" ? "Recently read" : "����Ķ�",
      title: resolvedLanguage === "en" ? "Book title" : "��������",
      progress: resolvedLanguage === "en" ? "Reading progress" : "�Ķ�����",
    }),
    [resolvedLanguage],
  );
        ...
        <View style={[styles.shelfTools, isTablet && styles.shelfToolsTablet]}>
          <View style={styles.shelfSearchBox}>
            ...
            <TextInput
              ...
              placeholder={resolvedLanguage === "en" ? "Search title, author, or chapter" : "Ѱ�����������߻��½�"}
            ...
            {searchQuery ? (
              <Pressable
                accessibilityLabel={resolvedLanguage === "en" ? "Clear library search" : "����������"}
                hitSlop={10}
          ...
          <View style={styles.shelfToolRow}>
            ...
            <Pressable
              accessibilityLabel={resolvedLanguage === "en" ? "Choose library sort order" : "ѡ���������"}
        ...
        ListEmptyComponent={(
          <View style={styles.shelfEmpty}>
            ...
            <Text style={styles.shelfEmptyTitle}>
              {resolvedLanguage === "en" ? "No story found here" : "���ﻹû��Ѱ������"}
            </Text>
            ...
            >
              <Text style={styles.shelfEmptyActionText}>
                {resolvedLanguage === "en" ? "Show all books" : "����ȫ������"}
              </Text>
            </Pressable>
          </View>
        )}
          ...
          <View style={styles.sortHeader}>
            ...
            <View>
              <Text style={styles.sortTitle}>
                {resolvedLanguage === "en" ? "Arrange the shelf" : "Ϊ������һ��"}
              </Text>
              <Text style={styles.sortSubtitle}>
                {resolvedLanguage === "en" ? "Choose how stories meet you." : "ѡ��������������Ĵ���"}
              </Text>
            </View>
          </View>
