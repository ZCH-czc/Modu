...
</style></head><body><div class="card"><div class="mark">◌</div><div class="title">去故事生长的地方</div><div class="text">写下网址、书名或作者。<br>让墨读从喧闹中，替你拾回一页正文。</div><div class="hint">只带回你能够正常抵达的文字</div></div></body></html>`;
        ...
        <View style={styles.header}>
          <View style={styles.brand}>
            ...
            <View>
              ...
              <Text style={styles.subtitle}>循着网页，收拢一章正文</Text>
            </View>
          </View>
          ...
          {!url ? (
            <ScrollView contentContainerStyle={styles.browserHome} keyboardDismissMode="on-drag" keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} style={styles.browserHomeLayer}>
              <View style={styles.homeHero}>
                ...
                <Text style={styles.homeTitle}>循着文字，去赴下一场相遇</Text>
                <Text style={styles.homeSubtitle}>写下网址或名字，让故事沿着光走近</Text>
              </View>
              ...
              {webFavorites.length ? (
                ...
                <View style={styles.homeEmpty}>
                  ...
                  <Text style={styles.homeEmptyText}>把常去的故事入口，留在这一页</Text>
                </View>
              )}
              {webHistory.length ? (
                <>
